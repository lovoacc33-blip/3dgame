...
// --- Progression Management (Core Logic) ---
...
function createEnvironment() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        for(let j = 0; j < 6; j++) {
            ...
            // const foliageGeo3 = new THREE.ConeGeometry(4, 5, 12); // Reduced complexity for speed
...
// --- Game Logic, Player Actions, Collision, and Animation Loop (Core Logic) ---
